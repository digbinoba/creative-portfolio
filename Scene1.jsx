...
Command: npx gltfjsx@6.4.1 public/models/scene1.gltf -K -k 
*/
...
export function Model(props) {
  ...
  const { scene } = useGLTF('/scene1.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Empty" position={[0.107, 0.281, -0.575]} rotation={[3.121, 0.496, 3.09]}>
